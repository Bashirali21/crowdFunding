    ...
    public void onClicks() {
        binding.btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEmpty(binding.tvEnterFirstName) || isEmpty(binding.EtLastName)|| isEmpty(binding.EtEmail) || isEmpty(binding.EtAddress)) {//checking whether edit text is empty or not
